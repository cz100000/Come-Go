...
$('pauseButtonLabel').textContent=pause?'Pause bearbeiten':'Pause eintragen';$('pauseButtonSub').textContent=pause?`${pause} Minuten für heute eingetragen`:'Direkt für den heutigen Tag';
